...
public class Addressbook {
    ...
    public static void main(String[] args) {
        ...
        Contact details = new Contact("Mallepogu", "Alankritha", "S.R nagar, B.K Guda", "Hyderabad",
                                "Telangana", "mallepogualankritha@gmail.com", 500082, 75231523876L);
        System.out.println("contact details are mentioned below : \n");
